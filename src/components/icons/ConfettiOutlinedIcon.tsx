...
export function ConfettiOutlinedIcon({ className = "size-6", ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      className={className}
      aria-hidden="true"
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.40421 7.70843C7.52175 7.35581 7.96928 7.25016 8.2321 7.51299L16.9875 16.2684C17.2503 16.5312 17.1447 16.9787 16.792 17.0963L3.65898 21.4739C3.2681 21.6042 2.89623 21.2324 3.02652 20.8415L7.40421 7.70843ZM5.87257 18.6279L8.53407 10.6434L13.8571 15.9664L5.87257 18.6279Z" fill="currentColor"/>
